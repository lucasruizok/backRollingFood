...
searchInput.addEventListener(`keyup`, async (event)=> {
   ...
   let botones = filteredUsers.data.botones 
   console.log (botones)
   listUsers(usuariosFiltrados,botones);
})


function listUsers(usuarios,botones){
...
function generaBotones(botones){
